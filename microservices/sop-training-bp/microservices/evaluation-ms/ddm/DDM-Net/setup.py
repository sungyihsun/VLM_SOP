...
PACKAGE_LIST = [
    "modeling.tao_pytorch_backbone_v2",
]
...
setuptools.setup(
    ...
    version="1.0",
    description="NVIDIA's package for DNN implementation on PyTorch for use with TAO Toolkit.",
    ...
    ext_modules=[
        make_cuda_ext(
            ...
            module='modeling.tao_pytorch_backbone_v2.ops',
            sources=[
