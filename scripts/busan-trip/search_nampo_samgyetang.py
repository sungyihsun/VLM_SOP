# -*- coding: utf-8 -*-
"""
One-off: find 人蔘雞湯 (samgyetang) restaurants near 南浦洞 (Nampo-dong), Busan.
Same anchor-resolve + places:searchNearby technique as
scripts/busan-trip/search_haeundae_station_dinner.py.

Usage (CI): GOOGLE_PLACES_API_KEY=... python3 scripts/busan-trip/search_nampo_samgyetang.py
"""
import json, os, re, time, urllib.request, urllib.error

OUT_PATH = os.environ.get("NAMPO_SAMGYETANG_CANDIDATES_PATH", "candidate-results/nampo-samgyetang-candidates.json")
...
if not places:
    raise SystemExit(f"COULD NOT RESOLVE NAMPO-DONG: {STATION_QUERY} -> {data}")
station = places[0]
