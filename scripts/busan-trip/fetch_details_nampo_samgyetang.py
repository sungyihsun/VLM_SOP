...
南浦洞 samgyetang restaurants. Same technique as
scripts/busan-trip/fetch_details_cheongsapo.py.

FINAL_LIST_PATH: JSON array of exact candidate names to fetch.

Usage (CI): GOOGLE_PLACES_API_KEY=... python3 scripts/busan-trip/fetch_details_nampo_samgyetang.py
"""
import json, os, urllib.request, urllib.error, time

CANDIDATES_PATH = os.environ.get("NAMPO_SAMGYETANG_CANDIDATES_PATH", "candidate-results/nampo-samgyetang-candidates.json")
FINAL_LIST_PATH = os.environ.get("NAMPO_SAMGYETANG_FINAL_LIST_PATH", "candidate-results/nampo-samgyetang-final-list.json")
OUT_PATH = os.environ.get("NAMPO_SAMGYETANG_DETAILS_PATH", "candidate-results/nampo-samgyetang-details.json")
